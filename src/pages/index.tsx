    ...
    <>
      <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#1a1a1a] to-[black]">
        <div className="container flex flex-col items-center justify-center px-4 py-16 ">
          ...
          <p className="load -translate-y-3 pt-4 hidden md:block text-center text-slate-400 transition duration-500">
          ...
          <div className="load flex -translate-y-3 items-center gap-2 pt-8 transition duration-200">
            {signingIn ? (
              <svg
                aria-hidden="true"
                className="mt-4 h-8 w-8 animate-spin fill-white dark:text-gray-600"
                viewBox="0 0 100 101"
                fill="none"
