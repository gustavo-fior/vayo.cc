    ...
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#1a1a1a] to-[black]">
        <motion.div
          ...
          className="flex flex-col justify-center px-4 py-16 w-full max-w-[60rem]"
        >
          ...
          <p className=" py-3  text-slate-400 transition duration-500">
            This Privacy Policy describes how Bookmarks collects, uses, and discloses personal information when you
            use the Bookmarks Chrome extension (the
            &quot;service&quot;).
          </p>
          ...
          <p className=" py-3  text-slate-400 transition duration-500">
            ...
            users. We simply fetch your current session from the Chrome API (cookies) and 
            use it to fetch your folders and save your bookmarks.
          </p>
          <h2 className="pt-4 text-xl font-bold text-slate-100 transition duration-500">
            Data Security
          </h2>
          ...
          <p className=" py-3  text-slate-400 transition duration-500">
            ...
            do not hesitate to contact us at [Your Contact Information].
          </p>
        </motion.div>
      </main>
    </>
