          ...
          >
            <div className="flex items-center gap-2">
              <input
                ...
                placeholder="https://..."
                className="w-72 rounded-full bg-white/10 px-6 py-2 font-semibold text-white no-underline placeholder:font-normal placeholder-zinc-600 transition duration-300 hover:bg-white/20 md:w-96"
              />
              <motion.button
                whileTap={{
                  scale: 0.8,
